...
<html>
   <head>
      ...
      <link rel="stylesheet" href="<?php if(isset($projectFolder)){ echo '/'.$projectFolder; } ?>/templates/protostar/kupiglobal/css/style.css">
      <style>
         .ter-cnt{
         padding:25px;
         }
                                             ...
                                             <div class="row">
                                                 <div class="col-sm-12">
                                                      <div class="main_heading">Privacy Policy</div><br>
                                                            <p><strong>Last updated&nbsp;:</strong>&nbsp; December 18, 2021</p><br>
                                                             ...
                                                             <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.termsfeed.com/blog/sample-privacy-policy-template/">Privacy Policy Template</a>.</p><br>
                                                              <p><strong>Interpretation and Definitions</strong></p><br>
                                                              <h4><strong>Interpretation</strong></h4><br>
                                                              ...
                                                              <h4><strong>Definitions</strong></h4><br>
                                                              <p><strong>For the purposes of this Privacy Policy:</strong></p><br>
                                                              <p><strong>Account&nbsp;:</strong> &nbsp;means a unique account created for You to access our Service or parts of our Service.</p>
                                                              <p><strong>Affiliate&nbsp;:</strong> &nbsp;means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.</p>
                                                              <p><strong>Applicationt&nbsp;:</strong> &nbsp;means the software program provided by the Company downloaded by You on any electronic device, named BoxonStoreManager</p>
                                                              <p><strong>Company&nbsp;:</strong>&nbsp; (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Kupi Global LLC, 67 Brookfield Drive.</p>
                                                              ...
                                                              <p><strong>Usage Datat&nbsp;:</strong> &nbsp;refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
                                                              <p><strong>Website&nbsp;:</strong>&nbsp; refers to Kupi Global, accessible from <a href="kupiglobal.com">kupiglobal.com</a></p>
                                                              ...
                                                              <h3><strong>Types of Data Collected</strong></h3><br>
                                                              <h4><strong>Personal Data</strong></h4><br>
                                                             ...
                                                             <p>Usage Data</p><br>
                                                             <h4><strong>Usage Data</strong></h4><br>
                                                            ...
                                                            <h4><strong>Tracking Technologies and Cookies</strong></h4><br>
                                                           ...
                                                           <p><strong>For business transfers&nbsp;:</strong>&nbsp; We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about our Service users is among the assets transferred.</p>
                                                            ...
                                                            <p>We may share Your personal information in the following situations:</p>
                                                             <ul>
                                                                 ...
                                                                 <h3><strong>Retention of Your Personal Data</strong></h3><br>
                                                               ...
                                                               <h3><strong>Transfer of Your Personal Data</strong></h3><br>
                                                               ...
                                                               <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
                                                                ...
                                                                <ul>
                                                                <li><strong>By email: info@kupiglobal.com</strong></li>
                                                                </ul>
                                                            </div>
                                                        </div>
                                                    </div>
