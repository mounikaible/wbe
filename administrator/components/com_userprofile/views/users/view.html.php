...
/**
 * View class for a list of Userprofile.
 *
 * @since  1.6
 */
class UserprofileViewUsers extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		UserprofileHelper::addSubmenu('users');
	...
	protected function addToolbar()
	{
		...
		$canDo = UserprofileHelper::getActions();

		JToolBarHelper::title(JText::_('COM_USERPROFILE_TITLE_USERS'), 'users.png');
		...
		{
			JToolBarHelper::preferences('com_userprofile');
		}

		// Set sidebar action - New in 3.0
		JHtmlSidebar::setAction('index.php?option=com_userprofile&view=users');
	}
