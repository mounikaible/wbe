...
// 		var_dump($result);exit;
     ...
     * @return  bool
     */
   public static function getShippmentDetails($CustId,$paymenttype,$wherhourec,$invidk,$qty,$destination,$volres,$munits,$source,$shiptype,$service,$dvalue,$bustype,$lengthStr,$widthStr,$heightStr,$grosswtStr,$volumeStr,$volumetwtStr,$dvalueStr,$shipmentCost,$destCnt,$rateType)
    {
        //  service 1
...
//      var_dump($msg);exit;
   ...
   public static function getdatapaypal($user)
      ...
      public static function getlabels($langSel)
    {
        ...
        $ch = curl_init();
        $url="http://boxonsaasdev.inviewpro.com//api/ImgUpldFTP/ConvertResxXmlToJson?companyId=130&language=".$langSel;
        curl_setopt($ch, CURLOPT_URL,$url);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        $resp = curl_exec($ch);
