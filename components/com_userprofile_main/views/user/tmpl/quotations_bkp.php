        ...
        $joomla.ajax({
            ...
            beforeSend: function() {
              ...
              if(cospor[3]>0){
                 ...
                 var fico=0;
                 fico=(parseFloat(quotcost)+parseFloat(sum)).toFixed(2);
                 if(cospor[6]>0){
        ...
        <form name="userprofileFormOne" id="userprofileFormOne" method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row">
			    <div class="col-sm-12 col-md-6">
			        <div class="form-group">
			            <label><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_SOURCE')  ?> <span class="error">*</span></label>
			    ...
			    <div class="col-sm-12 col-md-6">
			        <div class="form-group">
			            ...
			            <label><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_DESTINATION')  ?>:&nbsp;<span class="error">*</span></label>
			...
			<div class="row">
			    <div class="col-sm-6 col-md-6">
			        <div class="form-group">
			            <label><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_SHIPMENT_TYPE')  ?> <span class="error">*</span></label>
			    ...
			    <div class="col-sm-6 col-md-6">
			        <div class="form-group">
			            <label><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_SERVICE_TYPE')  ?> <span class="error">*</span></label>
			...
			<div class="row">
			    <div class="col-sm-12 col-md-6">
			        <div class="form-group">
			            <label><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_MEASUREMENT_UNITS')  ?> <span class="error">*</span></label>
			    ...
			    <div class="col-sm-12 col-md-6">
			        <div class="form-group">
			        	<!--<label class="invisable d-block">&nbsp;</label>-->
			            <label><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_WEIGHT_UNITS')  ?>:&nbsp;<span class="error">*</span></label>
            ...
            <div class="row">
                ...
                <div class="table-responsive">
	        		<table class="table table-bordered theme_table" id="gtable">
	        			<thead>
							<tr>
								<th><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_ITEM_NAME')  ?></th>
								<th><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_PACKAGE')  ?></th>
								<th><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_COMMODITY')  ?></th>
								<th><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_QUANTITY')  ?> </th>
								<th><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_LENGTH')  ?> </th>
								<th><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_WIDTH')  ?> </th>
								<th><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_HEIGHT')  ?></th>
								<th><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_GROSS_WT_ITEM')  ?></th>
								<th><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_GROSS_WT')  ?></th>
								<th><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_VOLUME')  ?></th>
								<th><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_VOLUMETRIC_WT')  ?></th>
							</tr>
	        			</thead>
	        			<tbody><tr><td><input type="text" class="form-control" name="txtItemName[]" id="4"><div id="errsItemname"></div>  </td>
	        			<td><select class="form-control" name="txtPackageList[]" id="1">
			                ...
			                ?>
			            </select></td><td><select class="form-control" id="4" name="txtCommodity[]">
			                <option value="">Select</option>
			                <?php
			...
			<div class="row shp-blk1">
			    <div class="col-sm-4 col-md-4 text-left">
                    <p class="shpprice"> <label><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_SHIPPING_COST')  ?> : </label><span id="divquotationCost" ></span> </p>
                     <p class="shpprice"><label><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_ADDITIONAL_COST')  ?> :</label><span id="divadditionalCost" ></span> </p>
                     <p class="shpprice"><label><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_DISCOUNT')  ?> :</label><span id="divdiscountCost" ></span></p>
                     <p class="shpprice"><label><?php echo Jtext::_('COM_USERPROFILE_QUOTATION_TABLE_FINAL_COST')  ?> :</label><span id="divfinalCost" ></span> </p>
			...
			<input type="hidden" class="form-control" name="txtfinalCost">
			        ...
			        <input type="submit" name="submit" value="<?php echo Jtext::_('COM_USERPROFILE_QUOTATION_SUBMIT')  ?>" class="btn btn-primary">
			    </div>
			</div>
