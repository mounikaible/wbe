...
$joomla(document).ready(function(){
    ...
    $joomla(function() {
        ...
        messages: {  // Specify validation error messages
          txtShipperName:{
              selectBox: "Please select shippername"
          },
        ...
        //   txtSourceCntry: "<?#php echo $assArr['source_error']; ?>",
          txtSourceCntry: {
                    selectBox: "Please select source country"
   			  },
          txtDestinationCntry:{
              selectBox: "Please select Destination country"
          },
    ...
    <div class="panel-body">
      ...
      <form name="userprofileFormOne" id="userprofileFormOne" method="post" action="">
        <div class="row">
          ...
          <?php } if($elem['ShipperAddress'][1] == "ACT"){  ?>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
        ...
        <div class="row">
             <?php  if($elem['ConsigneeName'][1] == "ACT"){  ?>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
           ...
           <?php } if($elem['ConsigneeAddress'][1] == "ACT"){  ?>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
        ...
        <div class="row">
             <?php } if($elem['ThirdPartyName'][1] == "ACT"){  ?>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
           ...
           <?php } if($elem['ThirdPartyAddress'][1] == "ACT"){  ?>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
        ...
        <div class="row">   
         <?php if($elem['TypeOfShipment'][1] == "ACT"){  ?>
          ...
          <div class="col-sm-3 col-md-3">
           ...
           <?php } if($elem['MeasurementUnits'][1] == "ACT"){  ?>
          <div class="col-sm-3 col-md-3">
            <div class="form-group">
        ...
        <div class="row">
            <?php if($elem['PickupAddress'][1] == "ACT"){  ?>
          ...
          <?php } if($elem['Notes'][1] == "ACT"){  ?>
          <div class="col-sm-6 col-md-6">
            <div class="form-group">
              <label><?php echo $assArr['notes']; ?><span class="error">*</span></label>
              <textarea class="form-control" name="txtNotes" <?php if($elem['Notes'][3]){ echo "readonly";  } ?> <?php if($elem['Notes'][2]){ echo "required";  } ?>></textarea>
            </div>
          </div>
          <?php } ?>
        </div>
