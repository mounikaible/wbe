         ...
         <div class="col-sm-12 col-md-3">
              <div class="form-group">
                 <label><?php echo $assArr['rMA_Value']; ?><?php if($elem['RMAValue'][2]){ ?><span class="error">*</span><?php } ?></label>
                    <input  class="form-control" name="rmavalue[]"  id="rmavalue_1" value="<?php echo $elem['RMAValue'][4]; ?>" <?php if($elem['RMAValue'][3]){ ?> readonly <?php } ?><?php if($elem['DeclaredValue'][2]){ echo "required"; } ?> maxlength="100" <?php if($elem['RMAValue'][2]){ echo "required"; } ?> >
              </div>
            </div>
        ...
        <div class="modal-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="form-group">
             <label><?php echo $assArr['width']; ?><?php if($elem['Width'][2]){ ?><span class="error">*</span> <?php } ?></label>
                 <input type="text" class="form-control" name="txtWidth" maxlength="100" <?php if($elem['Width'][3]){ ?> readonly <?php } ?> <?php if($elem['Width'][2]){ echo "required"; } ?>>            </div>
            </div>
              <?php } if(strtolower($elem['Height'][1]) == strtolower("ACT")){ ?>
            <div class="col-sm-12 col-md-4">
              <div class="form-group">
