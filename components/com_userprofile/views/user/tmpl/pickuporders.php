...
// dynamic elements
   ...
   $res = Controlbox::dynamicElements('PickUpOrder');
   $elem=array();
...
$joomla(document).ready(function(){
    ...
    $joomla('input[name="btnCalculate"]').click(function(e){
      ...
      if($joomla("form[name='userprofileFormOne']").valid()==true && $joomla('input[name=txtquotationCost]').val()==0){
        ...
        }else if($joomla("form[name='userprofileFormOne']").valid()==false){
  ...
  <div class="main_panel persnl_panel">
    ...
    <div class="panel-body">
      ...
      <form name="userprofileFormOne" id="userprofileFormOne" method="post" action="">
        <div class="row">
             <?php if(strtolower($elem['ShipperName'][1]) == strtolower("ACT")){  ?>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo $assArr['shipper_Name'];  ?> <span class="error">*</span></label>
              <select class="form-control" name="txtShipperName" <?php if($elem['ShipperName'][2]){ echo "required";  } ?>>
          ...
          <?php } if(strtolower($elem['ShipperAddress'][1]) == strtolower("ACT")){  ?>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo $assArr['shipper_Address']  ?> <span class="error">*</span></label>
              <input type="text" class="form-control" name="txtShipperAddress" <?php if($elem['ShipperAddress'][2]){ echo "required";  } ?>>
            </div>
          </div>
          <?php } ?>
          <div class="col-sm-4 col-md-4">
        ...
        <div class="row">
             <?php  if(strtolower($elem['ConsigneeName'][1]) == strtolower("ACT")){  ?>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo $assArr['consignee_Name']  ?> <span class="error">*</span></label>
              <select class="form-control" name="txtConsigneeName" <?php if($elem['ConsigneeName'][2]){ echo "required";  } ?>>
                <option value="">Select</option>
                <?php
           ...
           <?php } if(strtolower($elem['ConsigneeAddress'][1]) == strtolower("ACT")){  ?>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo $assArr['consignee_Address'];  ?> <span class="error">*</span></label>
              <input type="text" class="form-control"  name="txtConsigneeAddress" <?php if($elem['ConsigneeAddress'][2]){ echo "required";  } ?>>
            </div>
          </div>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
        ...
        <div class="row">
             <?php } if(strtolower($elem['ThirdPartyName'][1]) == strtolower("ACT")){  ?>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo $assArr['third_Party_Name']  ?><span class="error">*</span> </label>
              <select class="form-control" name="txtThirdPartyName" <?php if($elem['ThirdPartyName'][3]){ echo "readonly";  } ?><?php if($elem['ThirdPartyName'][2]){ echo "required";  } ?>>
                <option value="">Select</option>
                <?php
           ...
           <?php } if(strtolower($elem['ThirdPartyAddress'][1]) == strtolower("ACT")){  ?>
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo $assArr['third_Party_Address'];  ?><span class="error">*</span></label>
              <input type="text" class="form-control" name="txtThirdPartyAddress" <?php if($elem['ThirdPartyAddress'][3]){ echo "readonly";  } ?> <?php if($elem['third_Party_Address'][2]){ echo "required";  } ?>>
            </div>
          </div>
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="txtSourceCntry"  name="txtSourceCntry" <?php if($elem['Source'][2]){ echo "required";  } ?>>  
                <option value="">Select</option>
                <?php
          ...
          <div class="col-sm-12 col-md-6">
            <div class="form-group">
              ...
              <select class="form-control"  name="txtDestinationCntry" id="txtDestinationCntry" <?php if($elem['Destination'][2]){ echo "required";  } ?>>
                <option value="">Select</option>
                <?php
         ...
         <?php if(strtolower($elem['TypeOfShipment'][1]) == strtolower("ACT")){  ?>
		  <div class="col-sm-3 col-md-3">
            <div class="form-group">
              ...
              <select class="form-control" name="txtTypeOfShipperName" <?php if($elem['TypeOfShipment'][2]){ echo "required";  } ?>>
                <option value="">Select</option>
                <?php
          ...
          <div class="col-sm-3 col-md-3">
            <div class="form-group">
              ...
              <select class="form-control"  name="txtServiceType" <?php if($elem['ServiceType'][2]){ echo "required";  } ?>>
                <option value="">Select</option>
                <?php
                    foreach($resWp->ServiceType_List as $key=>$row){ ?>
                        <!--echo '<option value="'.$row->id_values.'">'.$row->desc_vals.'</option>';-->
                         <option data-id="<?php echo $row->value; ?>" value="<?php echo $row->id_values; ?>" <?php if (strtolower($row->id_values) == strtolower($elem['ServiceType'][4]) ) { echo "selected"; } ?>  ><?php echo $row->desc_vals;  ?></option>
                   <?php } ?>
          ...
          <div class="col-sm-3 col-md-3">
            <div class="form-group">
              ...
              <select class="form-control"  name="txtMeasurementUnits" <?php if($elem['MeasurementUnits'][2]){ echo "required";  } ?>>
                <option value="">Select</option>
                <?php
        ...
        <div class="row">
            <?php if(strtolower($elem['Name'][1]) == strtolower("ACT")){  ?>
          <div class="col-sm-12 col-md-6">
            <div class="form-group">
              <label><?php echo $assArr['shipper_Name'];  ?><span class="error">*</span></label>
              <input class="form-control" type="text" name="txtName" value="<?php echo $elem['Name'][4]; ?>" <?php if($elem['Name'][3]){ ?> readonly <?php } ?><?php if($elem['shipper_Name'][2]){ echo "required";  } ?>>
            </div>  
          </div> 
          <?php } if(strtolower($elem['PickupDate'][1]) == strtolower("ACT")){  ?>
          <div class="col-sm-12 col-md-6">
            <div class="form-group">
              <label><?php echo $assArr['pickup_Date']; ?><span class="error">*</span></label>
              <input class="form-control" type="text" name="txtPickupDate"   value="<?php echo $elem['PickupDate'][4]; ?>" <?php if($elem['PickupDate'][3]){ ?> readonly <?php } ?><?php if($elem['PickupDate'][2]){ echo "required";  } ?>>
            </div>  
          </div>
          <?php } ?>
        </div>  
        ...
        <div class="row">
            <?php if(strtolower($elem['PickupAddress'][1]) == strtolower("ACT")){  ?>
          <div class="col-sm-6 col-md-6">
            <div class="form-group">
              <label><?php echo $assArr['pickup_Address'];  ?><span class="error">*</span></label>
              <textarea class="form-control" name="txtPickupAddress" <?php if($elem['PickupAddress'][3]){ echo "readonly";  } ?><?php if($elem['PickupAddress'][2]){ echo "required";  } ?> ></textarea>
            </div>
          </div>
          <?php } if(strtolower($elem['Notes'][1]) == strtolower("ACT")){  ?>
          <div class="col-sm-6 col-md-6">
            <div class="form-group">
              <label><?php echo $assArr['notes']; ?><span class="error">*</span></label>
              <textarea class="form-control" name="txtNotes" value="<?php echo $elem['Notes'][4]; ?>" <?php if($elem['Notes'][3]){ echo "readonly";  } ?> <?php if($elem['Notes'][2]){ echo "required";  } ?>></textarea>
            </div>
          </div>
          <?php } ?>
        </div>
