...
$joomla(document).ready(function() {
    $joomla(document).on('click','.convertToPickup',function(e){
  ...
  /*$joomla('#j_table').on('click','a',function(e){
   ...
   $joomla('#W_table').on('click','a',function(e){
    e.preventDefault();
...
<div class="container">
	<div class="main_panel persnl_panel">
        ...
        <div class="row">
	        	<div class="col-md-12">
	        		<table class="table table-bordered theme_table" id="W_table">
	        			<thead>
							<tr>
                                ...
                                <th><?php echo $assArr['Convert To Pickup'];?></th>
...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
    ...
    var userid='<?php echo $user;?>';
      $joomla('select[name="txtShipperName"]').change(function(){
        ...
        if(userid==shipvb[2]){
            $joomla('input[name="hiddenShipperAsCustomer"]').val("true");
            $joomla('input[name="hiddenShipperNameId"]').val(shipvb[2]);
        }else{
            $joomla('input[name="hiddenShipperAsCustomer"]').val("false");
    ...
    $joomla('select[name="txtConsigneeName"]').change(function(){
        ...
        // alert(convb[2]);
         if(userid==convb[2]){
            $joomla('input[name="hiddenConsigneeAsCustomer"]').val("true");
            $joomla('input[name="hiddenConsigneeId"]').val(convb[2]);
        }else{
            $joomla('input[name="hiddenConsigneeAsCustomer"]').val("false");
    ...
    $joomla('select[name="txtThirdPartyName"]').change(function(){
        ...
        if(userid==thirdvb[2]){
            $joomla('input[name="hiddenThirdpartyAsCustomer"]').val("true");
            $joomla('input[name="hiddenThirdPartyId"]').val(thirdvb[2]);
        }else{
            $joomla('input[name="hiddenThirdpartyAsCustomer"]').val("false");
    ...
    $joomla(".pic_order_cancel").click(function(){
      
      $joomla("select").val("").change();
    //   $joomla("input,textarea").not(".btn-close1").val("");
    $joomla("input[name='txtShipperName'],input[name='txtShipperAddress'],input[name='txtConsigneeName'],input[name='txtConsigneeAddress'],input[name='txtThirdPartyName'],input[name='txtShipperAddress'],input[name='txtThirdPartyAddress'],input[name='txtName'],input[name='txtPickupDate'],textarea").val("");
    
    $joomla("input[name='txtChargableWeight']").prop("checked", false);
        ...
        <div>
          <input type="button" data-dismiss="modal" value="x" class="btn-close1 pic_order_cancel">
        ...
        <div class="modal-body">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="txtShipperName" required>
                    ...
                    foreach($resWp->Shipper_List as $key=>$row){
                        ...
                        echo '<option value="'.$row->Name.':'.$row->Address.':'.$row->UserId.'">'.$row->Name.'</option>';
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              ...
              <input type="button" value="Cancel" data-dismiss="modal" class="btn btn-danger pic_order_cancel">
            </div>
          </div>
        </div>
         
        
         <input type="hidden" name="hiddenShipperAsCustomer" value="">
         <input type="hidden" name="hiddenConsigneeAsCustomer" value="">
         <input type="hidden" name="hiddenThirdpartyAsCustomer" value="">
