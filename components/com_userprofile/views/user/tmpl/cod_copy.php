        ...
        onApprove: function(data, actions) {
          return actions.order.capture().then(function(orderData) {
            ...
            element.innerHTML = '';
                        ...
                        $joomla.ajax({
                       			url: ajaxurl,
                       			data: { "paymentgatewayflag":1,"ratetypeStr": "","Conveniencefees":$joomla('input[name="Conveniencefees"]').val(),"addSerStr":"","addSerCostStr":"","companyId":$joomla('input[name="companyId"]').val(),"insuranceCost":"","extAddSer":"","paypalinvoice":"","page":"cod","inhouseNo":$joomla('input[name="InHouseNostr"]').val(),"invoice":$joomla('input[name="InvoiceNo"]').val(),"InhouseIdkstr":$joomla('input[name="InhouseIdkstr"]').val(),"TxnId":orderData.id},
                       			dataType:"text",
                       			type: "get",
                                beforeSend: function() {
                                   $joomla(".page_loader").show();
