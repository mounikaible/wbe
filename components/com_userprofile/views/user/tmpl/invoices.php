  ...
  $joomla(document).on('click','input[name="cc"]',function(){
       ...
       // convenience fees 
        ...
        beforeSend: function() {
                ...
                $joomla('#DueAmount').text(Number(totFinalCost).toFixed(2));
	      ...
	      <table class="table table-bordered theme_table export_table">
	        	<thead>
							<tr>
                                ...
                                <th><?php echo $assArr['Due amount'];?></th>
                                <th><?php echo $assArr['Pay'];?></th>
							</tr>
	        </thead>	
            <tbody>
                      <?php
...
function initPayPalButton() {
            ...
            element.innerHTML = '';
                ...
                if($joomla('input[name="cc"]:checked').val() == "Paypal"){
                    ...
                    setTimeout(function () {
                        ...
                        $joomla.ajax({
                       			url: ajaxurl,
                       			data: { "paymentgatewayflag":1,"ratetypeStr": "","Conveniencefees":$joomla('input[name="Conveniencefees"]').val(),"addSerStr":"","addSerCostStr":"","companyId":$joomla('input[name="companyId"]').val(),"insuranceCost":"","extAddSer":"","paypalinvoice":"","page":"cod","inhouseNo":$joomla('input[name="InHouseNostr"]').val(),"invoice":$joomla('input[name="InvoiceNo"]').val(),"InhouseIdkstr":$joomla('input[name="InhouseIdkstr"]').val(),"InvoiceType":$joomla('input[name="InvoiceType"]').val(),"TxnId":txnId},
                       			dataType:"text",
                       			type: "get",
                                beforeSend: function() {
   ...
   //paypal smartbuttons hide 
   
    $joomla('.btn-close1').click(function() {
      $joomla('.paypalCreditDebit').hide();
    });
