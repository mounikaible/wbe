...
$DomainEmail = $domainDetails[0]->PrimaryEmail;
 ...
 // dynamic elements
   ...
   $res = Controlbox::dynamicElements('FulFillment');
   $elem=array();
  ...
  return str.replace(rgxtrim, '');
    ...
    //expand button icon
       ...
       $joomla(document).on('click','.wrchild',function(){
        ...
        rs = rs.replace(/\s/g,'');
        htmse+='<tr class="'+rs+'"><td colspan="6"><table class="table table-bordered child_row"><th style="display:none"></th><th>FNSKU</th><th>Quantity of FNSKU?*</th><th>SKU</th><th colspan="2">UPC</th><th style="display:none"></th></tr>';
    ...
    // expand all button
     ...
     $joomla('.expand_all_btn').on('click',function(e){
          var rowCount = $joomla("table tbody .wrchild:visible ").length;
      if(rowCount < 1){
                ...
                <div class="panel-body">
                    ...
                    <div class="acrdin-blk">
                        <div class="accordion"><?php echo $assArr['IPS/RAR'];?> <i class="fa fa-caret-down pull-right" aria-hidden="true"></i></div>
                         <div class="panel acrdin-bdy">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                     <?php if(strtolower($elem['AccountNumber'][1]) == strtolower("ACT")){  ?>
                                <div class="col-md-12 form-group">
                                <label class="col-md-4 col-form-label"><?php echo $assArr['Account_Number'];?><sub>*</sub></label>
                                <div class="col-md-8">
                                <input type="text" class="form-control" name="txtAccountnumber" name="txtAccountnumber" value="<?php echo $user;?>" <?php if($elem['AccountNumber'][3]){ ?> readonly <?php } ?> <?php if($elem['AccountNumber'][2]){ echo "required"; } ?>>
                                </div>
                                </div>
                                <?php } ?>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    <?php if(strtolower($elem['AccountName'][1]) == strtolower("ACT")){ ?>
                                    <div class="col-md-12 form-group">
                                        <label class="col-md-4 col-form-label"><?php echo $assArr['Account_Name'];?><sub>*</sub></label>
                                        <div class="col-md-8">
                                            <input type="text" class="form-control" name="txtAccountname"  id="txtAccountname" value="<?php echo $UserView->UserName;?>" <?php if($elem['AccountName'][3]){ ?> readonly <?php } ?> <?php if($elem['AccountName'][2]){ echo "required"; } ?>>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                    ...
                    <div class="acrdin-blk">
                        ...
                        <div class="panel acrdin-bdy">
                            ...
                            <?php if(strtolower($elem['DefineProject'][1]) == strtolower("ACT")){  ?>
                            <div class="form-group col-md-6">
                                <div class="form-group">
                                      <label class="col-md-4 col-form-label"><?php echo $assArr['Project_Name'];?><sub>*</sub></label>
                                    <div class="col-md-8">
                                         <input type="text" class="form-control"  name="txtProjectname" maxlength="50"  id="txtProjectname" autocomplete="off" value="<?php echo $elem['DefineProject'][4]; ?>" <?php if($elem['DefineProject'][3]){ ?> readonly <?php } ?> <?php if($elem['DefineProject'][2]){ echo "required"; } ?>>
                    ...
                    <div class="acrdin-blk">
                        <div class="accordion"><?php echo $assArr['IPS/RAR'];?><i class="fa fa-caret-down pull-right" aria-hidden="true"></i></div>
                        <div class="panel acrdin-bdy">
                          <?php if(strtolower($elem['ProductName'][1]) == strtolower("ACT")){  ?>  
                        ...
                        <div class="col-md-8">
                        <input type="text" class="form-control" maxlength="50"  name="txtProductTitle"  id="txtProductTitle" autocomplete="off" value="<?php echo $elem['ProductName'][4]; ?>" <?php if($elem['ProductName'][3]){ ?> readonly <?php } ?> <?php if($elem['ProductName'][2]){ echo "required"; } ?>>
                        </div>
                        </div>
                        <?php } ?>
                        <div id="tabs1">
                        <div class="rows"> 
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12">
                                 <?php if(strtolower($elem['FNSKUno'][1]) == strtolower("ACT")){  ?> 
                                ...
                                <input type="text" class="form-control rowValidate" maxlength="20"  name="txtFnsku[]"  id="1" autocomplete="off" value="<?php echo $elem['FNSKUno'][4]; ?>" <?php if($elem['FNSKUno'][3]){ ?> readonly <?php } ?> <?php if($elem['FNSKUno'][2]){ echo "required"; } ?>>
                                </div>
                                
                                 <?php } if(strtolower($elem['FNSKUqty'][1]) == strtolower("ACT")){  ?>
                                <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12 cls-addcol">
                                <label class="col-form-label"><?php echo $assArr['What is the quantity of product per_FNSKU'];?><span class="error">*</span></label>
                                <input type="text" class="form-control rowValidate" maxlength="5" name="txtFnskuquanity[]" id="2" value="<?php echo $elem['FNSKUqty'][4]; ?>"  <?php if($elem['FNSKUqty'][3]){ ?> readonly <?php } ?> <?php if($elem['FNSKUqty'][2]){ echo "required"; } ?>>
                                </div>
                                <?php } if(strtolower($elem['UPC'][1]) == strtolower("ACT")){  ?>
                                <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12 cls-addcol">
                                <label class="col-form-label"><?php echo $assArr['upc'];?><span class="error">*</span></label>
                                <input type="text" class="form-control rowValidate" maxlength="20"  name="txtUPC[]"  id="3"  value="<?php echo $elem['UPC'][4]; ?>"  <?php if($elem['UPC'][3]){ ?> readonly <?php } ?> <?php if($elem['UPC'][2]){ echo "required"; } ?>>
                                </div>
                                 <?php } if(strtolower($elem['SKU'][1]) == strtolower("ACT")){  ?>
                                <div class="form-group col-lg-3 col-md-3 col-sm-3 col-xs-12 cls-addcol">
                                <label class="col-form-label"><?php echo $assArr['sKU'];?></label>
                                <input type="text" class="form-control" maxlength="20" name="txtSKU[]" id="4" value="<?php echo $elem['SKU'][4]; ?>" <?php if($elem['SKU'][3]){ ?> readonly <?php } ?> >
                                </div>
                                <?php } ?>
                    ...
                    <div class="acrdin-blk">
                            <div class="accordion"><?php echo $assArr['IPS/RAR'];?> <i class="fa fa-caret-down pull-right" aria-hidden="true"></i></div>
                            <div class="panel acrdin-bdy">
                                <?php $result =Controlbox::getnewservices($UserView->CustId); if(count($result->Data) > 0){  ?>
                                <div class="col-md-12">
                                <h4>Service(s) Requested</h4>
                                    ...
                                    <div class="col-md-7">
                                        <?php if(strtolower($elem['RequestedDate'][1]) == strtolower("ACT")){  ?>
                                    ...
                                    <div class="col-md-7">
                                    <input type="text" class="form-control" id="dateTxt" name="dateTxt" <?php if($elem['RequestedDate'][3]){ ?> readonly <?php } ?> <?php if($elem['RequestedDate'][2]){ echo "required"; } ?>>
                                    </div>
                                    </div>
                                    <?php } ?>
                                    </div>
                    ...
                    <div class="acrdin-blk">
                        ...
                        <div class="panel acrdin-bdy">
                          <?php if(strtolower($elem['Upload'][1]) == strtolower("ACT")){  ?>
                        <div class="col-md-12">
                                             ...
                                             <div class="input-group finputfile">
                                                  <span class="btn-block"> 
                                                    <span class="btn btn-file"> <?php echo $assArr['choose_file'];?> 
                                                        <input type="file" multiple class="uploadFilenames" name="uploadFiles[]"  id="uploadFiles_1" <?php if($elem['Upload'][3]){ ?> readonly <?php } ?> > <!--onchange="javascript:updateList()"-->
                                                    </span>
                                                   </span>
                                            </div>
                                        </div>
            ...
            <div class="row">
               <div class="col-sm-12 inventry-item">
                   <div class="col-sm-6">
                    ...
                    <div class="col-sm-6 form-group text-right inventry-item-right">
               ...
               for($i=0 ; $i < count($rg->FBAFormItems) ;$i++){
                echo '<tr id="'.str_replace(" ","",$rg->ProjectName).'" style="display:none"><td style="display:none"></td><td>'.$rg->FBAFormItems[$i]->FNSKUNo.'</td><td>'.$rg->FBAFormItems[$i]->QuantityperFNSKU.'</td><td>'.$rg->FBAFormItems[$i]->SKUNo.'</td><td>'.$rg->FBAFormItems[$i]->UPC.'</td><td style="display:none"></td></tr>';
                }  
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="AccountNumberTxt" <?php if($elem['AccountNumber'][3]){ ?> readonly <?php } ?> <?php if($elem['AccountNumber'][2]){ echo "required"; } ?> >
              </div>
            </div>
             <?php } if(strtolower($elem['AccountName'][1]) == strtolower("ACT")){ ?>
            <div class="col-sm-12 col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control"  name="AccountNameTxt" <?php if($elem['AccountName'][3]){ ?> readonly <?php } ?> <?php if($elem['AccountName'][2]){ echo "required"; } ?> >
              </div>
            </div>
            <?php } ?>
          </div>
          <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" maxlength="250" name="ProjectnameTxt" id="ProjectnameTxt" <?php if($elem['DefineProject'][3]){ ?> readonly <?php } ?> <?php if($elem['DefineProject'][2]){ echo "required"; } ?> >
           ...
           <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control"  name="OrderDateTxt" id="OrderDateTxt" <?php if($elem['RequestedDate'][3]){ ?> readonly <?php } ?> <?php if($elem['RequestedDate'][2]){ echo "required"; } ?>>
              </div>
            </div>
            <?php } if(strtolower($elem['ProductName'][1]) == strtolower("ACT")){  ?> 
            <div class="col-sm-12 col-md-6">
              <div class="form-group">
                ...
                <input type="text" class="form-control" maxlength="50"  name="productnameTxt" id="productnameTxt" <?php if($elem['ProductName'][3]){ ?> readonly <?php } ?> <?php if($elem['ProductName'][2]){ echo "required"; } ?> >
              </div>
            </div>
            <?php } ?>
          </div>
                    ...
                    <div class="row addrows2 cls-addrwclr">
                            <div class="input-grp srvc-grp col-md-3 col-sm-6 col-xs-6">
                                <div class="input-group finputfile">
                                            <span class="btn-block"> 
                                                <span class="btn btn-file"> <?php echo $assArr['choose_file'];?>  
                                                    <input type="file" class="form-control uploadFilenames_edit" multiple  name="editUploadFiles[]" id="editUploadFiles_1" <?php if($elem['Upload'][3]){ ?> readonly <?php } ?> >
                                                </span>
                                            </span>
                                </div>
                            </div>
