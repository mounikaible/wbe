<?php
   ...
   $PaypalEmail = '';
    ...
    //$invoiceCountRes = UserprofileHelpersUserprofile::GetInvoicesCount($user);
...
<script type="text/javascript">
          ...
          $joomla('#ord_ship #kk_table tbody').remove(); 
           ...
           if($joomla('#step1 #j_table tr').length>0){
                ...
                $joomla.each($joomla("input[name='txtId']:checked"), function(){
                 ...
                 $joomla('#srStr').val(sr);
                 $joomla('#dtStr').val(dt);
                 tds+='<td><span class="discardShip"></span></td>';
          ...
          if($joomla("#exampleModal").css('display')=="block"){
              ...
              if($joomla('input[name="shipment"]:checked').val()=="1"){
               ...
               $joomla.each($joomla("input[name='txtId']"), function(){ 
                   ...
                   $joomla(this).closest('tr').find('td:eq(5)').html(originalVal);
   ...
   $joomla(document).on('click','#goto_payment_scr',function(){
       ...
       $joomla('input[name=ccStr]').click(function(){
        ...
        $joomla(document).on('click','input[name=shipmentStr]',function(){
   ...
   //      });
   	...
   	$joomla('#addusers').on('click',function(){
           ...
           // Specify validation error messages
           messages: {
             fnameTxt: {required:"<?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_FIRST_NAME_ERROR');?>",alphanumeric:"<?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_FIRSTNAME_ALPHABET_ERROR');?>"},
             lnameTxt: {required:"<?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_LAST_NAME_ERROR');?>",alphanumeric:"<?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_LASTNAME_ALPHABET_ERROR');?>"},
             country2Txt: {selectBox:"<?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_COUNTRY_ERROR');?>"},
             state2Txt: {required:"<?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_STATE_ERROR');?>"},
             /*city2Txt: {selectBox:"Please select city"},
             zipTxt: "Please enter zip code",*/
             idtypeTxt: {required: "Please select Identity Type"},
             idvalueTxt: {required: "Please enter Identity Value"},
             addressTxt: "<?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_ADDRESS_ERROR');?>",
             emailTxt: {required:"<?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_EMAIL_ERROR');?>",email:"<?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_EMAIL_FORMAT_ERROR');?>"}
           },
           // Make sure the form is submitted to the destination defined
           // in the "action" attribute of the form when valid
           submitHandler: function(form) {
	...
	function(value, element) {
      ...
      $joomla(".wrchild").click(function(){
           $joomla(this).closest('tr').find('td:eq(5)').text($joomla(this).closest('tr').find('input[name="txtQty"]').val());
           if($joomla('input[name="shipment"]:checked').val()=="1"){
               var rs=$joomla(this).closest('tr').find('td:eq(1)').text();
               ...
               if($joomla(this).val()=='-'){
                  ...
                  $joomla.each($joomla('#tabs2 #j_table tbody tr#dfg'), function(){
                   ...
                   $joomla(this).closest('tr').find('td:eq(5)').text($joomla(this).closest('tr').find('input[name="txtItemQty"]').val());
               }else{
       ...
       $joomla('#tabs2 #j_table .wrchild').each( function () {
           ...
           console.log(r);
           $joomla(this).closest('tr').find('td:eq(5)').text(r);
       ...
       $joomla('#tabs2 #u_table .wrchild').each( function () {
           ...
           console.log(rr);
           $joomla(this).closest('tr').find('td:eq(5)').text(rr);
               ...
               <div class="col-sm-12">
                  <div class="rdo_cust">
                     <div class="rdo_rd1">
                        ...
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_TITLE2');?></label>
                        <?php } if($elem['Holdshipments'][1] == "ACT"){  ?>
                        <input type="radio" name="shipment"  class="ishipment" value="2">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_HOLD_LABEL');?></label>
                        <?php } ?>
                     </div>
               ...
               <div class="col-sm-12 inventry-item">
                   <div class="col-sm-6">
                    ...
                    <div class="col-sm-6 form-group text-right">
                        <a style="color:white;" href="<?php echo JURI::base(); ?>/csvdata/hold_list.csv" class="btn btn-primary csvDownload export-csv">Export CSV</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                  ...
                  <div class="table-responsive">
                     <table class="table table-bordered theme_table" id="u_table" data-page-length='10'>
                        <thead>
                           <tr>
                              <th class="action_btns text-center"><input type="checkbox" name="selectAll" id="selectAll"><?php echo Jtext::_('COM_USERPROFILE_SELECT_ALL_TEXT');?></th>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_WHEREHOUSE');?>#</th>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_ITEM_DESC');?></th>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_TRACKING_ID');?></th>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_MERCHANT_NAME');?></th>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_QUANTITY');?></th>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_SHIP_QUANTITY');?></th>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_SHIPMENT_TYPE');?></th>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_SOURCE_HUB');?></th>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_DESTINATION');?></th>
                               <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_DESTINATION_HUB');?></th>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_WT_UNITS');?></th>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_MEASUREMENT_UNITS');?></th>
                              <th><?php echo Jtext::_('Order ID');?></th>
                              <th><?php echo Jtext::_('RMA Value');?></th>
                              <?php if($Gross_weight_display){ ?>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_GROSS_WEIGHT');?></th>
                               <?php } ?>
                              <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_TABLE_VIEW_IMAGE');?></th>
                           ...
                           <?php
                              ...
                              if($rg->ItemImage==""){
                                       ...
                                       $sim=str_replace(":","#",$rg->ItemImage);
                                            $sim1=str_replace(":","#",$rg->ItemImage1);
                                            $sim2=str_replace(":","#",$rg->ItemImage2);
                                            $sim3=str_replace(":","#",$rg->ItemImage3);
                                            $mgtd='<td class="action_btns"><a class="ship_img" data-toggle="modal" data-backdrop="static" data-keyboard="false" href="#" data-id="'.$rg->ItemImage.'##'.$rg->ItemImage1.'##'.$rg->ItemImage2.'##'.$rg->ItemImage3.'" data-target="#view_image" ><i class="fa fa-eye"></i></a></td>';
                                     
                                    }
                                    $grosswtTd = NULL;
                                     if($Gross_weight_display){
                                         $grosswtTd = "<td>".$rg->weight."</td>";
                                     }
                                          
                                       echo '<tr>
                                        		<td class="action_btns">
                                                 
                                                  <input type="checkbox" class="check-invisable" name="txtId" value="'.$rg->ItemName.':'.$rg->BillFormNo.':'.$rg->ItemQuantity.':'.$rg->TrackingId.':'.$rg->ItemId.':'.$rg->cost.':'.$rg->cost.':'.$idf.':'.$volres.':'.$rg->ServiceType.':'.$rg->source.':'.$rg->destination.':'.$rg->MeasureUnits.':'.$rg->length.':'.$rg->width.':'.$rg->height.':'.$rg->weight.':'.$rg->mass_unit.':'.$sim.':'.$rg->shipment_type.':'.$rg->source_hub.':'.$rg->destination_name.':'.$rg->dest_hub_id.':'.$rg->Insurance.':'.$rg->ItemPrice.':'.$sim1.':'.$sim2.':'.$sim3.'">
                                        			<input type="button" name="ship" class="ship" data-id="'.$rg->ItemName.':'.$rg->BillFormNo.':'.$rg->ItemQuantity.':'.$rg->TrackingId.':'.$rg->ItemId.':'.$rg->cost.':'.$rg->cost.':'.$idf.':'.$volres.':'.$rg->ServiceType.':'.$rg->source.':'.$rg->destination.':'.$rg->MeasureUnits.':'.$rg->length.':'.$rg->width.':'.$rg->height.':'.$rg->weight.':'.$rg->mass_unit.':'.$sim.':'.$rg->shipment_type.':'.$rg->source_hub.':'.$rg->destination_name.':'.$rg->dest_hub_id.':'.$rg->Insurance.':'.$rg->ItemPrice.':'.$sim1.':'.$sim2.':'.$sim3.'" data-target="#ord_ship" title="'.Jtext::_('COM_USERPROFILE_SHIP_HISTORY_STATUS_SHIP').'">
                                        		</td>
                                        		<td><input type="hidden" name="txtQty" value="'.$rg->Quantity.'"><input type="hidden" name="txtItemQty" ><input type="hidden" name="txtbiladdress" value="'.UserprofileHelpersUserprofile::getBindShipingAddress($user,$rg->BillFormNo).'">'.$rg->BillFormNo.'</td>
                                        		<td>'.$rg->ItemName.'</td>
                                        		<td>'.$rg->TrackingId.'</td>
                                        		<td>'.$rg->SupplierId.'</td>
                                        		<td>'.$rg->ItemQuantity.'</td>
                                        		<td><input type="hidden" name="ItemIdkTxt" value="'.$rg->ItemId.'"><input type="hidden" name="ItemQtyTxt" value="'.$rg->ItemQuantity.'"><input type="hidden" name="ItemQtyEdit" value="'.$rg->ItemQuantity.'">
                                              <input type="text" class="form-control" name="txtQty" value="'.$rg->ItemQuantity.'"></td>
                                        		<td>'.$rg->shipment_type_desc.'</td>
                                        		<td><div id="sourcehub" style="display:none">'.$rg->source_hub.'</div>'.$rg->source_hub.'</td>
                                        	    <td>'.$rg->destination_name.'</td>
                                        	    <td>'.$rg->dest_hub_name.'</td>
                                        		<td>'.$rg->mass_unit.'</td>
                                        		<td>'.$rg->distance_units.'</td>
                                        		<td>'.$rg->OrderIdNew.'</td>
                                        		<td>'.$rg->RMAValue.'</td>'.$grosswtTd.$mgtd.'</tr>';
                                              $p=$rg->BillFormNo;
                           ...
                           <?php
                            ...
                            //   var_dump($ordersPendingView);exit;
                              ...
                              foreach($ordersPendingView as $rg){
                                ...
                                //   echo UserprofileHelpersUserprofile::getShippmentDetailsValues($rg->MeasureUnits,$rg->shipment_type,$rg->ServiceType,$rg->source,$rg->destination)."<br>";
                                //   var_dump($rg);exit;
                                ...
                                if($rg->ItemQuantity>0){
                                    ...
                                    if($rg->shipment_type=="AIR"){
                                      $volres=$rg->Quantity*$volres;
                                    }
                                    if($rg->ItemImage==""){
                                        $sim=1; 
                                        $mgtd='<td>No Image</td>';
                                     ...
                                     $grosswtTd = "<td>".$rg->weight."</td>";
                                       ...
                                       echo '<tr>
                                        		<td class="action_btns">
                                                    ...
                                                    <input type="checkbox" class="check-invisable" name="txtId" data-sno="'.$idf.'" value="'.$rg->ItemName.':'.$rg->BillFormNo.':'.$rg->ItemQuantity.':'.$rg->TrackingId.':'.$rg->ItemId.':'.$rg->cost.':'.$rg->cost.':'.$idf.':'.$volres.':'.$rg->ServiceType.':'.$rg->source.':'.$rg->destination.':'.$rg->MeasureUnits.':'.$rg->length.':'.$rg->width.':'.$rg->height.':'.$rg->weight.':'.$rg->mass_unit.':'.$sim.':'.$rg->shipment_type.':'.$rg->source_hub.':'.$rg->destination_name.':'.$rg->dest_hub_id.':'.$rg->Insurance.':'.$rg->ItemPrice.':'.$sim1.':'.$sim2.':'.$sim3.':'.$rg->type_busines.'">
                                        			<input type="button" name="ship" class="ship" data-sno="'.$idf.'" data-id="'.$rg->ItemName.':'.$rg->BillFormNo.':'.$rg->ItemQuantity.':'.$rg->TrackingId.':'.$rg->ItemId.':'.$rg->cost.':'.$rg->cost.':'.$idf.':'.$volres.':'.$rg->ServiceType.':'.$rg->source.':'.$rg->destination.':'.$rg->MeasureUnits.':'.$rg->length.':'.$rg->width.':'.$rg->height.':'.$rg->weight.':'.$rg->mass_unit.':'.$sim.':'.$rg->shipment_type.':'.$rg->source_hub.':'.$rg->destination_name.':'.$rg->dest_hub_id.':'.$rg->Insurance.':'.$rg->ItemPrice.':'.$sim1.':'.$sim2.':'.$sim3.':'.$rg->type_busines.'" data-target="#ord_ship" title="'.Jtext::_('COM_USERPROFILE_SHIP_HISTORY_STATUS_SHIP').'">';
                                        			if($elem['Hold'][1] == "ACT")
                                        			echo '<input type="button" name="Return" class="return" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-id="'.$rg->BillFormNo.':'.$rg->ItemId.':'.$rg->ItemQuantity.'" data-target="#ord_return"" title="'.Jtext::_('COM_USERPROFILE_SHIP_HISTORY_STATUS_RETURN').'">';
                                        			if($elem['Return'][1] == "ACT")
                                        			echo '<input type="button" name="Keep" class="keep" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-id="'.$rg->BillFormNo.':'.$rg->ItemId.':'.$rg->ItemQuantity.'" data-target="#ord_keep" " title="'.Jtext::_('COM_USERPROFILE_SHIP_HISTORY_STATUS_HOLD').'">';
                     ...
                     <div class="col-md-12">
                        <div class="table-responsive">
                           <table class="table table-bordered theme_table" id="j_table">
                              <thead>
                                 <tr>
                                    <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_JTABLE_ITEM_DESC');?></th>
                                    <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_JTABLE_WHEREHOUSE_RECEIPT');?></th>
                                    <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_JTABLE_QUANTITY');?></th>
                                    <th><?php echo Jtext::_('COM_USERPROFILE_SHIP_JTABLE_TRACKING_ID');?></th>
                                    <th>Delete</th>
                                 </tr>
                              </thead>
                           </table>
            ...
            <form name="userprofileFormFive" id="userprofileFormFive"  method="post" action="" enctype="multipart/form-data">
               ...
               <div id="step3" style="display:none">
                  ...
                  <input type='hidden' name='return'
                     value='<?php echo JURI::base(); ?>index.php?option=com_userprofile&&view=user&layout=response&invc=<?php echo $invoiceCountRes->Data; ?>&pay=<?php echo base64_encode(date("m/d/0Y"));?>'>
                  ...
                  <div class="row">
                     <div class="col-md-12">
                        <div class="finish-shipping">
                           ...
                           <!--      <label><?php echo Jtext::_($prepaid_text);?></label>-->
                           ...
                           <!-- <div class="rdo_cust">-->
                           <!--   <div class="rdo_rd1">-->
                           <!--       <div id="paymentgatewaysDiv">-->
                           <!--            <?php echo Controlbox::getpaymentgateways('PPD'); ?>-->
                           <!--       </div>-->
                           <!--   </div>-->
                           <!--</div>-->
                 ...
                 <div class="clearfix"></div>
                   <div class="form-group" id="credit_cards">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12 error paygaterrormsg"></div>
                           ...
                           <div class="clearfix"></div>
                           <!--<div class="rdo_cust prepaid_method_sec rdo_cust shp-addnew1" style="display:none;">-->
                           <!--   <input type="radio" name="prepaidMethod" value="authorize">-->
                           <!--   <label>Paypal</label>-->
                           <!--   <input type="radio" name="prepaidMethod" value="square">-->
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-header">
            <input type="button" data-dismiss="modal" value="x" class="btn-close1">
            <h4 class="modal-title"><strong><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_ADDITIONAL_ADDRESS');?></strong></h4>
         </div>
         <form name="userprofileFormSeven" id="userprofileFormSeven" method="post" action=""  enctype="multipart/form-data">
            ...
            <div class="modal-body pagshipdown">
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_USER_TYPE');?> <span class="error">*</span></label>
                        <input type="text" class="form-control" name="typeuserTxt" id="typeuserTxt" readonly>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_ID');?>  <span class="error">*</span></label>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_FIRST_NAME');?>  <span class="error">*</span></label>
                        <input type="text" class="form-control" name="fnameTxt" id="fnameTxt" maxlength="25">
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_LAST_NAME');?> <span class="error">*</span></label>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_ADDITIONAL_ADDRESS');?>  <span class="error">*</span></label>
                        <textarea type="text" class="form-control" name="addressTxt" id="addressTxt" maxlength="35"></textarea>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="form-group">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_ADDITIONAL_ADDRESS');?> 2 </label>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_COUNTRY');?> <span class="error">*</span></label>
                        <?php
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_STATE');?> <span class="error">*</span></label>
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_CITY');?></label>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_ZIPCODE');?> </label>
              ...
              <div class="row">
               ...
               <div class="row">
                  <div class="col-md-6">
                     <div class="form-group">
                        <label><?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_EMAIL');?> <span class="error">*</span></label>
               ...
               <div class="row">
                  <div class="col-md-12 text-center">
                     <input type="button" value="<?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_SAVE_BTN');?>" class="btn btn-primary">
                     <input type="button" value="<?php echo Jtext::_('COM_USERPROFILE_SHIP_POPUP_CANCEL_BTN');?>" data-dismiss="modal" class="btn btn-danger">
                  </div>
               </div>
            </div>
         </form>
...
<script type="text/javascript">
   ...
   }else if($joomla('input[name="cc"]:checked').val() == "authorize.net" || $joomla('input[name="cc"]:checked').val() == "Stripe"){
        
    //   if($joomla('input[name=cardnumberStr]').val() =='' || $joomla('input[name=txtccnumberStr]').val() == '' || $joomla('input[name=emailStr]').val() == '' || $joomla('select[name=MonthDropDownListStr]').val() == '' || $joomla('select[name=YearDropDownListStr]').val() == '' ){
    //       return false;
    //   }else{
    //      document.getElementById('userprofileFormFive').submit();
    //   }
