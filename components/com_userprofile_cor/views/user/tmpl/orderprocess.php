                                ...
                                if($repack->InhouseRepackLbl == ""){
                                    ...
                                    foreach($repack->WarehouseDetails as $res){
                                                ...
                                                if($Gross_weight_display){ 
                                                 ...
                                                 echo '<td>'.$repack->BusinessType.'</td>
                                                 </tr>';
                                        		...
                                        		<td>'.$assArr['action'].'</td>
                                        		<td>'.$assArr['item_Description'].'</td>
                                        		<td>'.$assArr['quantity'].'</td>
                                        		<td>'.$assArr['ship_quantity'].'</td>
                                        		<td>'.$assArr['tracking_ID'].'</td>
                                        		<td>'.$assArr['merchants_Name'].'</td>';
                                        		if($OrderId){
                                        		    echo '<td>Order Id</td>';
                                        		}
                                        		if($RmaVal){
                                        		    echo '<td>RMA Value</td>';
                                        		}
                                        		echo '<td>View image</td>';
                                                 if($Gross_weight_display){
                                                  echo '<td></td>';
                                                  }
                                            	echo '<td></td>
                                ...
                                if(1){ // $rg->ItemQuantity>0 
                                 ...
                                 // class="check-invisable"
                                      echo '<tr style="display:none;">
                                        		...
                                        		<td>'.$res->MerchantName.'</td>';
                                        		if($OrderId)
                                        		echo '<td>'.$rg->OrderID.'</td>';
                                        		if($RmaVal)
                                        		echo '<td>'.$rg->RmaValue.'</td>';
                                        		echo $mgtd.'<td></td>'.$grosswtTd.'<td></td>';
                                        		if(!$OrderId)
                                        		echo '<td></td>';
                                        		if(!$RmaVal)
                                        		echo '<td></td>';
