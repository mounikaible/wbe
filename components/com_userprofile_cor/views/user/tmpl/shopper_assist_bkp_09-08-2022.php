      ...
      <div class="panel-body">
        <form name="userprofileFormOne" id="userprofileFormOne" method="post" action="" enctype="multipart/form-data">
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="form-group">
                ...
                <label><?php echo Jtext::_($elem['MerchantName'][0]);?><?php if($elem['MerchantName'][2]){ ?><span class="error">*</span><?php } ?></label>
            ...
            <div class="col-sm-12 col-md-4">
              <div class="form-group">
                <label><?php echo Jtext::_($elem['MerchantWebsite'][0]);?><?php if($elem['MerchantWebsite'][2]){ ?><span class="error">*</span><?php } ?></label>
            ...
            <div class="col-sm-12 col-md-4">
              <div class="form-group">
                <label><?php echo Jtext::_($elem['ArticleName'][0]);?><?php if($elem['ArticleName'][2]){ ?><span class="error">*</span><?php } ?></label>
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="form-group">
                <label><?php echo Jtext::_($elem['ItemModel'][0]);?><?php if($elem['ItemModel'][2]){ ?><span class="error">*</span><?php } ?></label>
            ...
            <div class="col-sm-12 col-md-4">
              <div class="form-group">
                <label><?php echo Jtext::_($elem['ItemReference'][0]);?><?php if($elem['ItemReference'][2]){ ?><span class="error">*</span><?php } ?></label>
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-3">
              <div class="form-group">
                <label><?php echo Jtext::_($elem['Color'][0]);?><?php if($elem['Color'][2]){ ?><span class="error">*</span><?php } ?></label>
            ...
            <div class="col-sm-12 col-md-3">
              <div class="form-group">
                <label><?php echo Jtext::_($elem['Size'][0]);?><?php if($elem['Size'][2]){ ?><span class="error">*</span><?php } ?></label>
            ...
            <?php }if($elem['ArticleURL'][1] == "ACT"){  ?>  
             <div class="col-sm-12 col-md-3">
              <div class="form-group">
                <label><?php echo Jtext::_($elem['ArticleURL'][0]);?><?php if($elem['ArticleURL'][2]){ ?><span class="error">*</span><?php } ?></label>
            ...
            <div class="col-sm-12 col-md-3">
              <div class="form-group">
                <label><?php echo Jtext::_($elem['ItemDescription'][0]);?><?php if($elem['ItemDescription'][2]){ ?><span class="error">*</span><?php } ?></label>
          ...
          <div class="row">
            ...
            <div class="col-sm-12 col-md-3">
              <div class="form-group">
                <label><?php echo Jtext::_($elem['Quantity'][0]);?><?php if($elem['Quantity'][2]){ ?><span class="error">*</span><?php } ?></label>
            ...
            <div class="col-sm-12 col-md-3">
              <div class="form-group">
                <label> <?php echo Jtext::_($elem['ItemPrice'][0]);?><?php if($elem['ItemPrice'][2]){ ?><span class="error">*</span><?php } ?></label>
            ...
            <div class="col-sm-12 col-md-3">
              <div class="form-group">
                <label> <?php echo Jtext::_($elem['DeclaredValue'][0]);?><?php if($elem['DeclaredValue'][2]){ ?><span class="error">*</span><?php } ?></label>
            ...
            <table class="table table-bordered theme_table" id="N_table">
              <thead>
                <tr>
                  ...
                  <th><?php echo Jtext::_('COM_USERPROFILE_SHOPPER_ASSIST_TABLE_MERCHANT');?></th>
                  <th><?php echo Jtext::_('COM_USERPROFILE_SHOPPER_ASSIST_TABLE_ITEM_NAME');?></th>
                  <th><?php echo Jtext::_('COM_USERPROFILE_SHOPPER_ASSIST_TABLE_ITEM_QUANTITY');?></th>
                  <th><?php echo Jtext::_('COM_USERPROFILE_SHOPPER_ASSIST_TABLE_ITEM_PRICE');?></th>
                  <th><?php echo Jtext::_('COM_USERPROFILE_SHOPPER_ASSIST_TABLE_DECLARED_VALUE');?></th>
                ...
                <div class="col-md-12">
                  <div class="finish-shipping">
                    ...
                    <table class="table table-bordered theme_table" id="k_table">
                      <thead>
                        <tr>
                          <th><?php echo Jtext::_('COM_USERPROFILE_SHOPPER_ASSIST_K_TABLE_ITEM_NAME');?></th>
                          <th><?php echo Jtext::_('COM_USERPROFILE_SHOPPER_ASSIST_K_TABLE_QUANTITY');?></th>
                          <th><?php echo Jtext::_('COM_USERPROFILE_SHOPPER_ASSIST_K_TABLE_ITEM_COST');?></th>
                          <th><?php echo Jtext::_('COM_USERPROFILE_SHOPPER_ASSIST_K_TABLE_DECLARED_VALUE');?></th>
                        </tr>
                      </thead>
                    </table>
