...
$joomla(document).ready(function(){
    ...
    $joomla(function() {
        ...
        messages: {
          txtShipperName:"<?php echo Jtext::_("COM_USERPROFILE_ORDER_PICKUP_SELECT_SHIPPER_NAME")  ?>",
          ...
          txtServiceType: "<?php echo Jtext::_("COM_USERPROFILE_ORDER_PICKUP_SELECT_SERVICE_TYPE")  ?>",
          txtSourceCntry: "<?php echo Jtext::_("COM_USERPROFILE_ORDER_PICKUP_SELECT_SOURCE_COUNTRY")  ?>",
          txtDestinationCntry: "<?php echo Jtext::_("COM_USERPROFILE_ORDER_PICKUP_SELECT_DESTINATION_COUNTRY")  ?>",
          txtMeasurementUnits: "<?php echo Jtext::_("COM_USERPROFILE_ORDER_PICKUP_SELECT_MEASUREMENT_UNITS")  ?>",
          txtWeightUnits: "<?php echo Jtext::_("COM_USERPROFILE_ORDER_PICKUP_SELECT_WEIGHT_UNITS")  ?>",
          txtChargableWeight:"<?php echo Jtext::_("COM_USERPROFILE_ORDER_PICKUP_SELECT_PICKUP_INFO")  ?>",
          "txtItemName[]": "<?php echo Jtext::_("COM_USERPROFILE_ORDER_PICKUP_SELECT_ITEM_NAME")  ?>",
          "txtPackageList[]": "<?php echo Jtext::_("COM_USERPROFILE_ORDER_PICKUP_SELECT_PACKAGE")  ?>",
          "txtQuantity[]": "<?php echo Jtext::_("COM_USERPROFILE_ORDER_PICKUP_SELECT_QUANTITY")  ?>",
          "txtWeight[]": "<?php echo Jtext::_("COM_USERPROFILE_ORDER_PICKUP_SELECT_WEIGHT")  ?>"
        },
	...
	$joomla("form[name='userprofileFormTwo']").validate({
		...
		messages: {
			...
			lnameTxt:{
			    required: "Please enter lasst name",
			    alphanumeric: "please enter alphabet characters"
			},
            countryTxt: {
...
<div class="container">
  <div class="main_panel persnl_panel">
    <div class="main_heading"><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_TITLE')  ?></div>
    <div class="panel-body">
      ...
      <form name="userprofileFormOne" id="userprofileFormOne" method="post" action="">
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_SHIPPER_NAME')  ?> <span class="error">*</span></label>
          ...
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_SHIPPER_ADDRESS')  ?> <span class="error">*</span></label>
          ...
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label>&nbsp;</label>
              <input type="button" class="btn btn-primary btn-block" value="<?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_ADD_NEW')  ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#exampleModal">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_CONSIGNEE_NAME')  ?> <span class="error">*</span></label>
          ...
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_CONSIGNEE_ADDRESS')  ?> <span class="error">*</span></label>
          ...
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label>&nbsp;</label>
              <input type="button" class="btn btn-primary btn-block" value="<?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_ADD_NEW')  ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#exampleModal1">
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_THIRD_PARTY_NAME')  ?> </label>
          ...
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_THIRD_PARTY_ADDRESS')  ?></label>
          ...
          <div class="col-sm-4 col-md-4">
            <div class="form-group">
              <label>&nbsp;</label>
              <input type="button" class="btn btn-primary btn-block" value="<?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_ADD_NEW')  ?>" data-toggle="modal" data-backdrop="static" data-keyboard="false" data-target="#exampleModal2">
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_SOURCE')  ?> <span class="error">*</span></label>
          ...
          <div class="col-sm-12 col-md-6">
            <div class="form-group">
              ...
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_DESTINATION')  ?>:&nbsp;<span class="error">*</span></label>
        ...
        <div class="row">
            ...
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_THIRD_SHIPMENT_TYPE')  ?> <span class="error">*</span></label>
          ...
          <div class="col-sm-6 col-md-6">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_SERVICE_TYPE')  ?> <span class="error">*</span></label>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <div class="form-group">
              <!--<label class="invisable d-block">&nbsp;</label>-->
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_WEIGHT_UNITS')  ?>:&nbsp;<span class="error">*</span></label>
          ...
          <div class="col-sm-12 col-md-6">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_MEASUREMENT_UNITS')  ?> <span class="error">*</span></label>
          ...
          <div class="col-sm-12 col-md-6">
            <div class="rdo_cust">
                <div class="rdo_rd1">
                  ...
                  <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_SAME_AS_CUSTOMER')  ?></label>
                  <input type="radio" name="txtChargableWeight" value=2>
                  <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_SAME_AS_SHIPPER')  ?></label>
                </div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_NAME')  ?></label>
              <input class="form-control" type="text" name="txtName">
            </div>  
          </div>  
          <div class="col-sm-12 col-md-6">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_DATE')  ?></label>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_ADDRESS')  ?></label>
              <textarea class="form-control" name="txtPickupAddress"></textarea>
            </div>
          </div>
          <div class="col-sm-6 col-md-6">
            <div class="form-group">
              <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_NOTES')  ?></label>
          ...
          <div class="col-md-12">
            <div class="table-responsive">
              <table class="table table-bordered theme_table" id="gtable">
                <thead>
                  <tr>
					<th><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_ITEM_NAME')  ?></th>
					<th><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_PACKAGE')  ?></th>
					<th><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_QUANTITY')  ?> </th>
					<th><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_LENGTH')  ?> </th>
					<th><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_WIDTH')  ?> </th>
					<th><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_HEIGHT')  ?></th>
					<th><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_GROSS_WT_ITEM')  ?></th>
					<th><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_GROSS_WT')  ?></th>
					<th><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_VOLUME')  ?></th>
					<th><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_VOLUMETRIC_WT')  ?></th>
				  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td><input type="text" class="form-control" name="txtItemName[]" id="4">
                    </td>
                    ...
                    <td><input type="text" class="form-control" name="txtQuantity[]" maxlength="3" id="2"><div id="errsQuantity"></div> </td>
			            <td><input type="text" class="form-control" name="txtLength[]" id="txtLength" >  </td>
			            <td><input type="text" class="form-control" name="txtWidth[]" id="txtWidth" >  </td>
			            <td><input type="text" class="form-control" name="txtHeight[]" id="txtHeight" >  </td>
			            <td><input type="text" class="form-control" name="txtWeight[]" id="3" maxlength="15"><div id="errsWeight"></div>  </td>
        ...
        <div id="divApiResult"></div><br>
        
        <div class="row shp-blk1">
			    <div class="col-sm-4 col-md-4 text-left">
                    <p class="shpprice"><label><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_SHIPPING_COST')  ?> : </label><span id="divquotationCost" ></span> </p>
                     <p class="shpprice"><label><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_ADDITIONAL_COST')  ?> :</label><span id="divadditionalCost" ></span> </p>
                     <p class="shpprice"><label><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_DISCOUNT')  ?> :</label><span id="divdiscountCost" ></span></p>
                     <p class="shpprice"><label><?php echo Jtext::_('COM_USERPROFILE_ORDER_TABLE_FINAL_COST')  ?> :</label><span id="divfinalCost" ></span> </p>
        ...
        <div class="row">
          <div class="col-sm-12 col-md-12 text-center">
            ...
            <input type="button" name="btnCalculate" value="<?php echo Jtext::_('COM_USERPROFILE_ORDER_CALCULATE')  ?>" class="btn btn-primary" disabled>
            <input type="submit" name="submit" value="<?php echo Jtext::_('COM_USERPROFILE_ORDER_SUBMIT')  ?>" class="btn btn-primary">
          </div>
        </div>
      ...
      <form name="userprofileFormTwo" id="userprofileFormTwo" method="post" action="">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_USER_TYPE')  ?> </label>
                <input type="text" class="form-control" name="usertypeTxt"  value="Shipper" readonly>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_ID')  ?> </label>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_FIRST_NAME')  ?><span class="error">*</span></label>
                <input type="text" class="form-control" name="fnameTxt" id="fnameTxt" maxlength="25">
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_LAST_NAME')  ?><span class="error">*</span></label>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_COUNTRY')  ?> <span class="error">*</span></label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_STATE')  ?> <span class="error">*</span></label>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_CITY')  ?> <span class="error">*</span></label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_ZIPCODE')  ?><span class="error">*</span></label>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_ADDITIONAL_ADDRESS')  ?>  <span class="error">*</span></label>
                <textarea type="text" class="form-control" name="addressTxt" id="addressTxt" maxlength="35"></textarea>
              </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_EMAIL')  ?></label>
          ...
          <div class="row">
            <div class="col-md-12 text-center">
              <input type="submit" value="<?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_SAVE_BTN')  ?>" class="btn btn-primary">
              <input type="button" value="<?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_CANCEL_BTN')  ?>" data-dismiss="modal" class="btn btn-danger">
            </div>
          </div>
        </div>
      ...
      <form name="userprofileFormThree" id="userprofileFormThree" method="post" action="">
        <div class="modal-body">
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                <label><?php echo Jtext::_('COM_USERPROFILE_ORDER_PICKUP_POPUP_USER_TYPE')  ?> <span class="error">*</span></label>
